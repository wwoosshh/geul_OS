...
pub fn container(owner: ActorId) -> Object {
    Object::new(
        TypeUri::parse("aios.std/Container@1").expect("유효한 TypeUri"),
        owner,
    )
}
...
pub fn text(owner: ActorId, content: &str) -> Object {
    let mut obj = Object::new(
        TypeUri::parse("aios.std/Text@1").expect("유효한 TypeUri"),
        owner,
    );
...
pub fn button(owner: ActorId, label: &str) -> Object {
    let mut obj = Object::new(
        TypeUri::parse("aios.std/Button@1").expect("유효한 TypeUri"),
        owner,
    );
...
pub fn toggle(owner: ActorId, initial: bool) -> Object {
    let mut obj = Object::new(
        TypeUri::parse("aios.std/Toggle@1").expect("유효한 TypeUri"),
        owner,
    );
